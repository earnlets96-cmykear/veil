...
- Provides standard interfaces for:
  ...
  - `AEAD` authenticated encryption/decryption with random 24-byte or 12-byte nonces.
  - `Ed25519` keypair generation, message signing, and signature verification.
  - `X25519` key exchange (Diffie-Hellman scalar multiplication).
...
```
veil/
├── AGENTS.md                          # Root AI Agent operating contract
├── package.json                       # Zero-paid dependencies manifest
├── tsconfig.json                      # Strict TypeScript compiler options
├── vitest.config.ts                   # Vitest testing configuration
├── docs/
│   ├── ai/                            # AI Agent Continuity System
│   │   ├── PROJECT_CONTEXT.md
│   │   ├── CURRENT_STATE.md
│   │   ├── ACTIVE_TASK.md
│   │   ├── DECISIONS.md
...
│       ├── ARCHITECTURE.md
│       ├── SPACE_ARCHITECTURE.md
│       ├── KEY_HIERARCHY.md
│       ├── IDENTITY_AND_TRANSPORT.md
│       ├── THREAT_MODEL.md
│       └── UX_DESIGN_SYSTEM.md
├── src/
│   ├── crypto/                        # Core cryptographic primitives & wrappers
│   ├── spaces/                        # Multi-space isolation & vault envelope logic
│   ├── identity/                      # Space identity keypairs & verification
│   ├── messaging/                     # Double Ratchet & message envelope protocol
│   ├── transport/                     # Transport abstraction & relay client
│   ├── storage/                       # Encrypted local store abstraction
│   ├── ui/                            # React components & UI views
│   └── styles/                        # Custom Vanilla CSS Design System
├── server/                            # Lightweight untrusted relay server
└── tests/                             # Unit, negative, attack & isolation tests
```
