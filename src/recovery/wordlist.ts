...
export const BIP39_WORDLIST: readonly string[] = [
  ...
  'only', 'onto', 'open', 'opera', 'opinion', 'oppose', 'option', 'orange', 'orbit', 'orchard',
  ...
  'slide', 'slight', 'slim', 'slogan', 'slot', 'slow', 'slum', 'small', 'smart', 'smile',
  ...
  'used', 'useful', 'useless', 'usual', 'utility', 'vacant', 'vacuum', 'vague', 'valuable', 'value',
